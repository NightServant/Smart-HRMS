...
class SubmitIpcrRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'form_payload.sections.*.rows.*.self_assessment_qeta_scores.efficiency' => 'nullable|integer|min:1|max:5',
            'form_payload.sections.*.rows.*.self_assessment_qeta_scores.timeliness' => 'nullable|integer|min:1|max:5',
            'form_payload.sections.*.rows.*.self_assessment_qeta_scores.accountability' => 'nullable|integer|min:1|max:5',
