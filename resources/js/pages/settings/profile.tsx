                        ...
                        <div className="-mt-14 flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                            ...
                            <div className="grid w-full gap-2 text-sm text-muted-foreground sm:grid-cols-2 xl:w-auto xl:min-w-[19rem]">
                                ...
                                <div className="inline-flex min-w-0 items-center gap-2 rounded-full bg-background/80 px-3 py-2 shadow-sm backdrop-blur-sm">
                                    ...
                                    <span>{canEditProfile ? 'Self-managed account' : 'HR-managed account'}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {canEditProfile ? (
                    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(0,0.85fr)]">
                        <SectionCard
                            ...
                            description="Maintain the HR account identity shown across Smart HRMS."
                        >
                                ...
                                {({ processing, errors }) => (
                                    <>
                                        <div className="rounded-[24px] border border-border/70 bg-muted/5 p-5">
                                            <div className="mb-5 space-y-1">
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    Update the core details that identify this HR personnel account throughout the system.
                                                </p>
                                            </div>
                                        ...
                                        <div className="flex flex-col gap-3 border-t border-border/60 pt-5 sm:flex-row sm:items-center sm:justify-between">
                                            <p className="text-sm text-muted-foreground">
                                                Elevated role access is managed elsewhere and is not changed from this page.
                                            </p>
                        ...
                        <div className="grid gap-6">
                            ...
                            >
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    {shouldShowAccountManagementField && <ReadOnlyField label="Account management" value="HR-managed" />}
                        ...
                        >
                            <div className="space-y-3">
                                ...
                                <SidebarNote icon={BriefcaseBusiness}>
                                    Account profile changes can be coordinated through HR personnel.
                                </SidebarNote>
                                {shouldShowEmployeeProfile && (
