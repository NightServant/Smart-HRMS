...
type TargetStepStatus = 'completed' | 'current' | 'pending';

function TargetCycleStepper({
    isSubmitted,
    hasDraft,
    submissionOpen,
}: {
    ...
    const steps = [
        ...
        { key: 'reference', label: 'IPCR Reference' },
    ] as const;
    ...
    const currentStep = isSubmitted
        ...
        : hasDraft
          ...
          : submissionOpen
            ? 0
            : -1;
    const styles: Record<TargetStepStatus, { panel: string; icon: string }> = {
        completed: {
    ...
    function resolveStatus(stepIndex: number): TargetStepStatus {
        if (currentStep < 0) {
                ...
                <Card className="glass-card overflow-hidden border-border bg-card shadow-sm">
                    ...
                    <CardContent className="space-y-5 pt-6">
                        <TargetCycleStepper
                            ...
                            hasDraft={hasDraft}
                            submissionOpen={targetPeriod.submissionOpen}
                        />
