...
export default function EmployeeRemarks({
    ...
    return (
        <div className="glass-card flex h-full w-full min-w-0 flex-1 animate-fade-in-right flex-col gap-3 rounded-xl border border-border bg-card p-4 shadow-sm transition-shadow hover:shadow-md">
