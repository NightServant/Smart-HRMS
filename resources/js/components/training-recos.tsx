...
export default function TrainingRecommendations({ recommendations }: Props) {
    return (
        <div className={`${dashboardGlassCardClassName} flex w-full min-w-0 animate-fade-in-right flex-col gap-3 overflow-hidden rounded-xl p-4 transition-shadow hover:shadow-md sm:gap-4`}>
