...
export default function TrainingRecommendations({ recommendations, riskLevel }: Props) {
    ...
    return (
        <div className="animate-fade-in-right flex w-full flex-col gap-3 overflow-hidden rounded-xl border border-border bg-card p-4 shadow-sm hover:shadow-md transition-shadow sm:gap-4">
                    ...
                    <CarouselContent className="-ml-2 md:-ml-4">
                        ...
                        {recommendations.map((reco) => (
                            <CarouselItem key={reco.seminar_id} className="basis-full 2xl:basis-1/2">
                                <Card className="group bg-card py-4 shadow-sm hover:shadow-sm transition-shadow">
