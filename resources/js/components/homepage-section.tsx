...
const logoSideDepthLayers = Array.from(
    { length: 8 },
    (_, index) => 44 + index * 3.2,
);
...
export default function HomepageSection() {
    ...
    const handlePointerMove = (
        ...
        setTilt((current) => {
            ...
            return {
                spinX: Math.max(
                    -35,
                    Math.min(35, current.spinX - deltaY * 0.25),
                ),
    ...
    useEffect(() => {
        ...
        const loop = (): void => {
            if (!isDragging) {
                setTilt((current) => {
                    const nextVelocity =
                        Math.abs(spinVelocityY.current) > 0.005
                    ...
                    return {
                        ...
                        spinX:
                            current.spinX +
                            (defaultTilt.spinX - current.spinX) * 0.03,
    ...
    return (
        <section className="bg-video relative flex h-auto w-full overflow-x-hidden px-0 pt-28 pb-16 md:pt-32 md:pb-20">
            ...
            <div className="bg-video__content relative mx-auto grid w-full max-w-[1500px] grid-cols-1 items-center gap-10 px-4 sm:px-6 md:px-10 xl:grid-cols-12">
                <div className="xl:col-span-6">
                    <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-xs font-semibold tracking-wider text-primary uppercase shadow-sm">
                        HR Decision Support
                    </span>
                    ...
                    <p className="mx-auto flex max-w-2xl items-start gap-2 pt-4 pb-2 text-center text-lg font-medium text-foreground/80 md:text-xl xl:mx-0 xl:text-left">
                        Manage attendance, evaluations, leave requests, and
                        training programs — all in one place, built for public
                        sector institutions.
                    </p>
                        ...
                        >
                            ...
                            <div className="relative h-full w-full [transform-style:preserve-3d]">
                                ...
                                >
                                    ...
                                    <div className="pointer-events-none absolute inset-[20%] [transform:translateZ(44px)_rotateY(180deg)] overflow-hidden rounded-full border border-white/70 bg-background/85 shadow-[0_30px_80px_-35px_rgba(0,0,0,0.45)] [backface-visibility:hidden]">
                                        <img
                                    ...
                                    <div className="absolute inset-[20%] [transform:translateZ(70px)] overflow-hidden rounded-full border border-white/70 bg-background/85 shadow-[0_30px_80px_-35px_rgba(0,0,0,0.65)]">
                                        <img
                                            src="/images/SHRMS.png"
